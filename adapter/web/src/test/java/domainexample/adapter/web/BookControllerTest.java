...
public class BookControllerTest {
  ...
  public void getBookByIsbn() throws Exception {
    given(servicePort.getBookByIsbn("123-1234567895")).willReturn(Optional.of(
        Book.of(ISBN.of("123-1234567895"), "title", Author.of("author"))));
  ...
  public void getBookByIsbn_incorrectParam() throws Exception {
    given(servicePort.getBookByIsbn(any())).willThrow(ValidationException.class);
  ...
  public void storeBook_correctIsbn() throws Exception {
    ...
    given(servicePort.storeBook(any(), any(), any())).willReturn(book);
  ...
  public void deleteBookByID() throws Exception {
    var book = Book.of(ISBN.of("123-1234567895"), "title", Author.of("author"));
    given(servicePort.getBookByIsbn("123-1234567895")).willReturn(Optional.of(book));
